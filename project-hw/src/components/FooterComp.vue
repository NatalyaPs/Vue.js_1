<template>
    <footer class="footer center">
        <nav class="footer__main-link">
            <div class="footer__main-link_group">
                <a class="footer__main-link_svg" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34" fill="none">
                ...
                <a class="footer__main-link_title" href="#">Interno</a>
            </div>
            <p class="footer__main-link_text">It is a long established fact that a reader will be distracted lookings.</p>
            <div class="footer__main-link_icons">
        ...
        <nav class="footer__pages">
            <h3 class="footer__pages_title">Pages</h3>
            <a class="footer__pages_link" href="#">Home</a>
            <a class="footer__pages_link" href="#">Project</a>
            <a class="footer__pages_link" href="#">Blog</a>
        </nav>
        <div class="footer__empty-block"></div>
        <div class="footer__contact">
            <h3 class="footer__contact_title">Contact</h3>
            <p class="footer__contact_text">55 East Birchwood Ave. Brooklyn, New York 11201</p>
            <p class="footer__contact_text">contact@interno.com</p>
